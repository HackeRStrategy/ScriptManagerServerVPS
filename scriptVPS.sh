...
tput setaf 3 ; tput bold ; echo "INSTALANDO MENU MANAGER VPS"; tput sgr0
    wget https://raw.githubusercontent.com/HackeRStrategy/TrabajosEdicion10-/master/adm2fun -O /bin/adm2fun 1> /dev/null 2> /dev/stdout
    chmod +x /bin/adm2fun
sleep 2
...
tput setaf 7 ; tput bold ; echo "INSTALANDO MENU DE FERRAMENTAS"; tput sgr0
    wget https://raw.githubusercontent.com/HackeRStrategy/TrabajosEdicion10-/master/adm3fun -O /bin/adm3fun 1> /dev/null 2> /dev/stdout
    chmod +x /bin/adm3fun
sleep 2
...
tput setaf 3 ; tput bold ; echo "INSTALANDO DROPEAR"; tput sgr0
    wget https://raw.githubusercontent.com/HackeRStrategy/TrabajosEdicion10-/master/dropb -O /bin/dropb 1> /dev/null 2> /dev/stdout
    chmod +x /bin/dropb
sleep 2
tput setaf 3 ; tput bold ; echo "INSTALANDO ADICIONES DROPLET"; tput sgr0
    wget https://raw.githubusercontent.com/HackeRStrategy/TrabajosEdicion10-/master/dropb-inst -O /bin/dropb-inst 1> /dev/null 2> /dev/stdout
...
tput setaf 3 ; tput bold ; echo "INSTALANDO OPEN PORT"; tput sgr0
    wget https://raw.githubusercontent.com/HackeRStrategy/TrabajosEdicion10-/master/portas -O /bin/portas 1> /dev/null 2> /dev/stdout
    chmod +x /bin/portas
sleep 2
...
tput setaf 7 ; tput bold ; echo "INSTALANDO PROXY SQUID3"; tput sgr0
    wget https://raw.githubusercontent.com/HackeRStrategy/TrabajosEdicion10-/master/sq3 -O /bin/sq3 1> /dev/null 2> /dev/stdout
    chmod +x /bin/sq3
sleep 2
...
tput setaf 3 ; tput bold ; echo "INSTALANDO PROXY PYTHON 2"; tput sgr0
    wget https://raw.githubusercontent.com/HackeRStrategy/TrabajosEdicion10-/master/proxy2.py 1> /dev/null 2> /dev/stdout
    chmod +x proxy2.py
sleep 2
